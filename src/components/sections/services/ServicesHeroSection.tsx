  ...
  return (
    <section className="relative overflow-hidden bg-accent text-foreground">
      <div className="absolute inset-0 opacity-[0.08]">
        ...
        <div className="absolute right-0 bottom-0 h-112 w-md translate-x-1/3 translate-y-1/4 rounded-full bg-primary/45 blur-3xl" />
      </div>
        ...
        <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          ...
          <div className="rounded-4xl bg-card/70 p-8 shadow-xl backdrop-blur">
            ...
            <ul className="mt-6 space-y-4 text-sm leading-relaxed text-muted-foreground">
              {t.raw("foundations.items").map((item: string) => (
