...
# Knowledge base for generating answers
knowledge = {
...
for para in doc.paragraphs:
    ...
    if text and ('?' in text or any(text.startswith(word) for word in ['What', 'How', 'Why', 'When', 'Where', 'Who', 'Is', 'Are', 'Do', 'Does'])):
        ...
        if len(question) > 10 and question not in questions:
            ...
            if 'family structure' in q_lower or 'describe.*family' in q_lower:
